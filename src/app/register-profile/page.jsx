...
// The boundary MUST be a parent of any component that calls
// useSearchParams(), or static prerender bails out and the
// build fails. Do not call useSearchParams() in here.
// ─────────────────────────────────────────────────────────────
...
// Lightweight shell shown while the client hydrates the param-
// dependent form. Kept visually neutral so there's no layout jump.
        ...
        <div className="w-full max-w-[560px]">
          ...
          <div className="bg-white rounded-[var(--radius-lg)] border border-line-light p-8">
            ...
            <div className="flex flex-col gap-5">
              <div className="h-[46px] rounded-[var(--radius-md)] bg-line-light" />
              <div className="h-[46px] rounded-[var(--radius-md)] bg-line-light" />
            </div>
          </div>
        </div>
...
// ─────────────────────────────────────────────────────────────
// Inner component: all logic + the useSearchParams() call live
// here, safely BELOW the Suspense boundary.
// ─────────────────────────────────────────────────────────────
function ProfileForm() {
  ...
  const validateStep = () => {
    if (step === 1) {
      ...
      // optional: a light sanity check on length/digits
            ...
            {step === 2 && (
              <div>
                ...
                <div className="flex flex-col gap-5">
                  {!isSelf && (
                    <Field
                      label="Child's name *" id="learnerName" type="text"
