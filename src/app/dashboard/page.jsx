...
import { deleteFile, assignmentAttachments, submissionFiles } from '../../lib/uploadFile';
        ...
        <div style={{ borderTop: '1px solid #e2e8f0', padding: '20px', background: '#fafbfc' }}>
          ...
          {sub && isGraded && (
            <div style={{ marginTop: 14, padding: '14px 16px', borderRadius: 8, background: 'rgba(34,197,94,0.08)', border: '1px solid rgba(34,197,94,0.2)' }}>
              ...
              {sub.feedback && <div style={{ fontSize: 13, color: '#15803d', lineHeight: 1.6, marginBottom: sub.content || submissionFiles(sub).length ? 10 : 0 }}>{sub.feedback}</div>}
