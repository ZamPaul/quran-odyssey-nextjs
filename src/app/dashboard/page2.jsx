...
export default function DashboardPage() {
    ...
    const fetchProfile = async () => {
      try {
        ...
        if (res.ok) {
          ...
          console.log("request sent, res is ok");
  ...
  const courseLabel =
    profile?.courseInterest
      ?.replace(/_/g, " ")
      .toLowerCase()
      .replace(/\b\w/g, (c) => c.toUpperCase()) || "Quran Learning";
  ...
  return (
    ...
    >
      ...
      >
            ...
            return (
              <button
                ...
                style={{
                  ...
                  boxShadow: active
                    ? "inset 0 0 0 1px rgba(40,183,217,0.2)"
                    : "none",
              ...
              >
                ...
                <span
                  style={{
                    fontSize: 13,
                    fontWeight: 600,
                    color: active ? "#28b7d9" : "rgba(255,255,255,0.45)",
                    flex: 1,
                  }}
                >
                  {item.label}
        ...
        {/* User + Logout */}
        <div
          style={{ padding: 12, borderTop: "1px solid rgba(255,255,255,0.07)" }}
        >
          <div
            style={{
              display: "flex",
          ...
          {activeTab === "overview" && (
            <div>
              ...
              <div
                style={{
                  background:
                    "linear-gradient(135deg, #0d2840 0%, #142f4a 100%)",
                  borderRadius: 16,
                  padding: "28px 32px",
                  marginBottom: 24,
                  position: "relative",
              ...
              >
                <div
                  style={{
                    ...
                    height: 200,
                    background:
                      "radial-gradient(circle, rgba(40,183,217,0.15) 0%, transparent 70%)",
                    borderRadius: "50%",
                  }}
                />
                <div
              ...
              >
                {[
                  ...
                  {
                    label: "Course",
                    value: profile ? courseLabel.split(" ")[0] : "—",
                    sub: profile ? courseLabel : "Not enrolled",
                    color: "#7c3bee",
                  },
                ].map((stat) => (
                  <div
