const STATS = [
  { target: 2000, suffix: "+", label: "Students enrolled globally", featured: false },
  { target: 97, suffix: "%", label: "Parent satisfaction rate — students who start, stay", featured: true },
  { target: 40, suffix: "+", label: "Qualified, vetted teachers", featured: false },
  { target: 18, suffix: "+", label: "Countries · families everywhere", featured: false },
];
      ...
      <div className="relative z-[2] mx-auto w-full max-w-[1240px]">
        <div className="mb-14 grid grid-cols-1 gap-6 md:grid-cols-2 md:items-end">
          <div className="reveal-left">
            <div className="section-chip inline-flex items-center rounded-full border border-[color-mix(in_srgb,var(--brand-cyan)_20%,transparent)] bg-[color-mix(in_srgb,var(--brand-cyan)_12%,transparent)] px-4 py-[6px] text-[12px] font-[700] tracking-[0.06em] text-[color-mix(in_srgb,var(--brand-cyan)_90%,white)]">
              By the numbers
            </div>
        ...
        <div className="stat-grid reveal grid grid-cols-1 gap-4 md:grid-cols-4">
          {STATS.map((s) => (
            ...
            >
              <div
                className={[
                  "stat-num mb-1 text-[36px] font-[800] tracking-[-0.03em]",
