  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 14, color: "#64748b", marginBottom: 24 }}>
        Not sure? Your teacher will assess your child and confirm the right
        starting point.
      </p>
        ...
        {COURSE_OPTIONS.map((c) => {
          ...
          return (
            <button
              ...
              type="button"
              onClick={() => {
                setForm((f) => ({ ...f, courseType: c.value }));
                setError("");
              }}
              style={{
                display: "flex",
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 14, color: "#64748b", marginBottom: 28 }}>
        Select all days that work for your schedule. We'll do our best to match
        you.
      </p>
            ...
            return (
              <button
                ...
                style={{
                  padding: "9px 16px",
                  borderRadius: 8,
                  border: `2px solid ${selected ? "#0d2840" : "#e2e8f0"}`,
          ...
          {TIME_OPTIONS.map((t) => {
            ...
            return (
              <button
                ...
                type="button"
                onClick={() => {
                  setForm((f) => ({ ...f, preferredTime: t.value }));
                  setError("");
                }}
                style={{
                  flex: 1,
    ...
    <div>
          ...
          {GENDER_OPTIONS.map((g) => {
            ...
            return (
              <button
                ...
                type="button"
                onClick={() =>
                  setForm((f) => ({ ...f, genderPreference: g.value }))
                }
                style={{
                  flex: 1,
                  padding: "14px 10px",
      ...
      <div style={{ marginBottom: 28 }}>
        ...
        <textarea
          value={form.message}
          onChange={(e) =>
            setForm((f) => ({ ...f, message: e.target.value.slice(0, 500) }))
          }
      ...
      >
        ...
        {[
          [
            "Course",
            COURSE_OPTIONS.find((c) => c.value === form.courseType)?.label ||
              "—",
          ],
          [
            "Preferred Days",
            form.preferredDays.map((d) => DAY_LABELS[d]).join(", ") || "—",
          ],
          [
            "Preferred Time",
            TIME_OPTIONS.find((t) => t.value === form.preferredTime)?.label ||
              "—",
          ],
          [
            "Teacher Pref",
            GENDER_OPTIONS.find((g) => g.value === form.genderPreference)
              ?.label || "—",
          ],
        ].map(([label, value]) => (
          <div
      ...
      <div style={{ display: "flex", gap: 10 }}>
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 8,
            border: "none",
            background: submitting ? "#e2e8f0" : "#faa71a",
            color: submitting ? "#94a3b8" : "#0d2840",
            fontSize: 14,
            fontWeight: 800,
...
function SuccessState({ courseLabel }) {
  return (
    <div style={{ textAlign: "center", padding: "20px 0" }}>
      ...
      >
        Your enrollment application for{" "}
        <strong style={{ color: "#0f172a" }}>{courseLabel}</strong> has been
        received. We will review it and contact you within{" "}
        <strong>24 hours</strong>.
      </p>
      <div
        style={{
          background: "#e8f8fc",
          border: "1px solid rgba(40,183,217,0.25)",
          borderRadius: 10,
          padding: "16px 20px",
          marginBottom: 28,
          textAlign: "left",
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/enrollment/apply`,
        {
          method: "POST",
          headers: {
      ...
      <div style={{ maxWidth: 640, margin: "0 auto", padding: "0 20px" }}>
        ...
        >
          <div
            style={{
              height: 4,
              background: "linear-gradient(90deg, #28b7d9, #faa71a)",
            }}
          />
...
// This outer shell provides it — Next.js static generation won't crash.
